...
class phase_two_data_prep:
    ...
    def __init__(self, data_file, cat_cols, cont_cols, user_target_metadata):
        self.df = data_file
        self.cat_cols = cat_cols
        self.cont_cols = cont_cols

    def prep_nans(self):
        self.df = self.df.loc[:,self.df.isnull().mean() < .3]
    ...
    def prep_conts(self):
        ...
        cols = pd.DataFrame(scaler.fit_transform(cont))# Scales columns and assigns to dataframe
